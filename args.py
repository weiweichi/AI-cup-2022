args = {
    ...
    # model type
    "model_name": "coatnet", # CNN, coatnet, Res18, Res34, Res50, wide_res, densenet169, densenet121 and densenet201
    ...
    "n_workers": 4,
    "n_epoch": 50,
    "swa_start": 10,   # number of epoch to start SWA 
    "swa_lr": 5e-3,    # SWA lr
    
    "lr_warmup": 500,  # warm-up step
    "lr": 0.0025,    # lr * min(step ** (-0.5), step * lr_warmup ** (-1.5))
    "weight_decay": 1e-2,
    ...
    # predict
    "models_list": ["coatnet", 'Res34', 'Res50', 'densenet169']   # predict by fusion, see models.py for more detailed
}